...
- Java 21, Spring Boot 3.x + Spring Web, Spring Security, JdbcTemplate (MySQL), Lombok, Swagger/OpenAPI (034-store-performance-report)
- MySQL — 主要資料表：`order`、`lottery_ticket`、`lottery`、`wallet_transaction`、`store`、`user` (034-store-performance-report)
...
## Recent Changes
- 034-store-performance-report: Added Java 21, Spring Boot 3.x + Spring Web, Spring Security, JdbcTemplate (MySQL), Lombok, Swagger/OpenAPI
